...
module.exports = {
  async searchForNodes(count = 0, nodes) {
    const index = [];
    ...
    // const foundNodes = startSearch(index, 0);
  },


// async function startSearch(index, count, nodes) {
//   let end = count + 10;
//   let existingNodes = await Promise.all(inde)
// }
